...
var getTemplateId = require('./element-templates/Helper').getTemplateId;
...
function createElementTemplateGroups(
    element, canvas, bpmnFactory, elementRegistry, elementTemplates, translate) {

  // TODO: add description group
  var foo = elementTemplateDescriptionProps(element, elementTemplates);

  var customFieldsGroups = elementTemplateCustomProps(element, elementTemplates, bpmnFactory, translate);

  return [ foo ].concat(customFieldsGroups);
}
