...
var textInputField = require('./TextInputEntryFactory'),
    dateEntryField = require('./DateEntryFactory'),
    dialogEntryField = require('./DialogEntryFactory'),
    ...
    propSelectEntryFactory = require ('./PropSelectEntryFactory'),
...
EntryFactory.dateField = function(options) {
  return dateEntryField(options, setDefaultParameters(options));
};

EntryFactory.dialogField = function(options) {
  return dialogEntryField(options, setDefaultParameters(options));
};
...
EntryFactory.propSelect = function (options) {
  return propSelectEntryFactory(options, setDefaultParameters(options))
}
